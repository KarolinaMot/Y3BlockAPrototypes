...
struct Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_ChaosCaching_Source_ChaosCaching_Public_Chaos_CacheManagerActor_h_Statics
{
	...
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AChaosCacheManager, AChaosCacheManager::StaticClass, TEXT("AChaosCacheManager"), &Z_Registration_Info_UClass_AChaosCacheManager, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AChaosCacheManager), 2851342033U) },
		{ Z_Construct_UClass_AChaosCachePlayer, AChaosCachePlayer::StaticClass, TEXT("AChaosCachePlayer"), &Z_Registration_Info_UClass_AChaosCachePlayer, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AChaosCachePlayer), 615657143U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_ChaosCaching_Source_ChaosCaching_Public_Chaos_CacheManagerActor_h_3720080116(TEXT("/Script/ChaosCaching"),
