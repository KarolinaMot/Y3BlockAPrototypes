...
struct Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AudioMixer_Public_Quartz_QuartzSubsystem_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UQuartzSubsystem, UQuartzSubsystem::StaticClass, TEXT("UQuartzSubsystem"), &Z_Registration_Info_UClass_UQuartzSubsystem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UQuartzSubsystem), 3594530194U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AudioMixer_Public_Quartz_QuartzSubsystem_h_1325432737(TEXT("/Script/AudioMixer"),
