...
#include "ModelingComponents/Public/BaseTools/BaseMeshProcessingTool.h"
...
struct Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MeshModelingToolset_Source_ModelingComponents_Public_BaseTools_BaseMeshProcessingTool_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UBaseMeshProcessingToolBuilder, UBaseMeshProcessingToolBuilder::StaticClass, TEXT("UBaseMeshProcessingToolBuilder"), &Z_Registration_Info_UClass_UBaseMeshProcessingToolBuilder, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UBaseMeshProcessingToolBuilder), 3828710844U) },
		{ Z_Construct_UClass_UBaseMeshProcessingTool, UBaseMeshProcessingTool::StaticClass, TEXT("UBaseMeshProcessingTool"), &Z_Registration_Info_UClass_UBaseMeshProcessingTool, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UBaseMeshProcessingTool), 1693515894U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MeshModelingToolset_Source_ModelingComponents_Public_BaseTools_BaseMeshProcessingTool_h_300669009(TEXT("/Script/ModelingComponents"),
