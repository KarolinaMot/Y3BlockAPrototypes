...
struct Z_CompiledInDeferFile_FID_Engine_Source_Runtime_InteractiveToolsFramework_Public_BaseGizmos_GizmoBoxComponent_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UGizmoBoxComponent, UGizmoBoxComponent::StaticClass, TEXT("UGizmoBoxComponent"), &Z_Registration_Info_UClass_UGizmoBoxComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGizmoBoxComponent), 2645906844U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_InteractiveToolsFramework_Public_BaseGizmos_GizmoBoxComponent_h_2418111718(TEXT("/Script/InteractiveToolsFramework"),
