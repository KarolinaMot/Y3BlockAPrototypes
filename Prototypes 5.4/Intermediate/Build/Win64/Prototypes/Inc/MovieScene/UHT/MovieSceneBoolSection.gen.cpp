...
struct Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_Sections_MovieSceneBoolSection_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneBoolSection, UMovieSceneBoolSection::StaticClass, TEXT("UMovieSceneBoolSection"), &Z_Registration_Info_UClass_UMovieSceneBoolSection, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneBoolSection), 652632479U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_Sections_MovieSceneBoolSection_h_1288651414(TEXT("/Script/MovieScene"),
