...
struct Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Components_BackgroundBlurSlot_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UBackgroundBlurSlot, UBackgroundBlurSlot::StaticClass, TEXT("UBackgroundBlurSlot"), &Z_Registration_Info_UClass_UBackgroundBlurSlot, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UBackgroundBlurSlot), 961330333U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Components_BackgroundBlurSlot_h_1610784645(TEXT("/Script/UMG"),
