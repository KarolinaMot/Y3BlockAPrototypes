...
struct Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Components_MenuAnchor_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UMenuAnchor, UMenuAnchor::StaticClass, TEXT("UMenuAnchor"), &Z_Registration_Info_UClass_UMenuAnchor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMenuAnchor), 518168115U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Components_MenuAnchor_h_1836087120(TEXT("/Script/UMG"),
