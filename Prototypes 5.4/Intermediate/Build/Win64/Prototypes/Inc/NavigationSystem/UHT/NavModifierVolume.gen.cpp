...
struct Z_CompiledInDeferFile_FID_Engine_Source_Runtime_NavigationSystem_Public_NavModifierVolume_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ANavModifierVolume, ANavModifierVolume::StaticClass, TEXT("ANavModifierVolume"), &Z_Registration_Info_UClass_ANavModifierVolume, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ANavModifierVolume), 2929266208U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_NavigationSystem_Public_NavModifierVolume_h_710920503(TEXT("/Script/NavigationSystem"),
