...
struct Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AnimGraphRuntime_Public_AnimNodes_AnimNode_RotationOffsetBlendSpace_h_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FAnimNode_RotationOffsetBlendSpace::StaticStruct, Z_Construct_UScriptStruct_FAnimNode_RotationOffsetBlendSpace_Statics::NewStructOps, TEXT("AnimNode_RotationOffsetBlendSpace"), &Z_Registration_Info_UScriptStruct_AnimNode_RotationOffsetBlendSpace, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAnimNode_RotationOffsetBlendSpace), 4210601865U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AnimGraphRuntime_Public_AnimNodes_AnimNode_RotationOffsetBlendSpace_h_939176632(TEXT("/Script/AnimGraphRuntime"),
	nullptr, 0,
