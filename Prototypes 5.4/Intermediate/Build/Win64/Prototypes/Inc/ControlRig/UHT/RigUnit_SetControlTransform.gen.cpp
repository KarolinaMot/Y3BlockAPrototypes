...
struct Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_Units_Hierarchy_RigUnit_SetControlTransform_h_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FRigUnit_SetControlBool::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_SetControlBool_Statics::NewStructOps, TEXT("RigUnit_SetControlBool"), &Z_Registration_Info_UScriptStruct_RigUnit_SetControlBool, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_SetControlBool), 1326632187U) },
		...
		{ FRigUnit_SetControlFloat::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_SetControlFloat_Statics::NewStructOps, TEXT("RigUnit_SetControlFloat"), &Z_Registration_Info_UScriptStruct_RigUnit_SetControlFloat, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_SetControlFloat), 1300835519U) },
		...
		{ FRigUnit_SetMultiControlVector2D::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_SetMultiControlVector2D_Statics::NewStructOps, TEXT("RigUnit_SetMultiControlVector2D"), &Z_Registration_Info_UScriptStruct_RigUnit_SetMultiControlVector2D, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_SetMultiControlVector2D), 3313597666U) },
		{ FRigUnit_SetControlVector::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_SetControlVector_Statics::NewStructOps, TEXT("RigUnit_SetControlVector"), &Z_Registration_Info_UScriptStruct_RigUnit_SetControlVector, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_SetControlVector), 1736934033U) },
