...
struct Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_Units_Hierarchy_RigUnit_SetCurveValue_h_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FRigUnit_SetCurveValue::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_SetCurveValue_Statics::NewStructOps, TEXT("RigUnit_SetCurveValue"), &Z_Registration_Info_UScriptStruct_RigUnit_SetCurveValue, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_SetCurveValue), 3085945785U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_Units_Hierarchy_RigUnit_SetCurveValue_h_4098715281(TEXT("/Script/ControlRig"),
	nullptr, 0,
