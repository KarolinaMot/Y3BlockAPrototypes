...
struct Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_Units_Hierarchy_RigUnit_GetControlTransform_h_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FRigUnit_GetControlBool::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_GetControlBool_Statics::NewStructOps, TEXT("RigUnit_GetControlBool"), &Z_Registration_Info_UScriptStruct_RigUnit_GetControlBool, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_GetControlBool), 1571439642U) },
		{ FRigUnit_GetControlFloat::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_GetControlFloat_Statics::NewStructOps, TEXT("RigUnit_GetControlFloat"), &Z_Registration_Info_UScriptStruct_RigUnit_GetControlFloat, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_GetControlFloat), 2801721313U) },
		{ FRigUnit_GetControlInteger::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_GetControlInteger_Statics::NewStructOps, TEXT("RigUnit_GetControlInteger"), &Z_Registration_Info_UScriptStruct_RigUnit_GetControlInteger, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_GetControlInteger), 2551718809U) },
		...
		{ FRigUnit_GetControlVector::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_GetControlVector_Statics::NewStructOps, TEXT("RigUnit_GetControlVector"), &Z_Registration_Info_UScriptStruct_RigUnit_GetControlVector, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_GetControlVector), 3142276963U) },
		{ FRigUnit_GetControlRotator::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_GetControlRotator_Statics::NewStructOps, TEXT("RigUnit_GetControlRotator"), &Z_Registration_Info_UScriptStruct_RigUnit_GetControlRotator, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_GetControlRotator), 1872526847U) },
		{ FRigUnit_GetControlTransform::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_GetControlTransform_Statics::NewStructOps, TEXT("RigUnit_GetControlTransform"), &Z_Registration_Info_UScriptStruct_RigUnit_GetControlTransform, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_GetControlTransform), 1942374638U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_Units_Hierarchy_RigUnit_GetControlTransform_h_1073764812(TEXT("/Script/ControlRig"),
	nullptr, 0,
