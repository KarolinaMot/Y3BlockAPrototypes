...
const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UProceduralShapeToolProperties_Statics::NewProp_PolygroupMode = { "PolygroupMode", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UProceduralShapeToolProperties, PolygroupMode), Z_Construct_UEnum_MeshModelingTools_EMakeMeshPolygroupMode, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_PolygroupMode_MetaData), NewProp_PolygroupMode_MetaData) }; // 3681459679
...
const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UProceduralDiscToolProperties_Statics::NewProp_DiscType = { "DiscType", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UProceduralDiscToolProperties, DiscType), Z_Construct_UEnum_MeshModelingTools_EProceduralDiscType, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_DiscType_MetaData), NewProp_DiscType_MetaData) }; // 2075665327
...
const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UProceduralSphereToolProperties_Statics::NewProp_SubdivisionType = { "SubdivisionType", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UProceduralSphereToolProperties, SubdivisionType), Z_Construct_UEnum_MeshModelingTools_EProceduralSphereType, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_SubdivisionType_MetaData), NewProp_SubdivisionType_MetaData) }; // 2853022235
...
const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UProceduralStairsToolProperties_Statics::NewProp_StairsType = { "StairsType", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UProceduralStairsToolProperties, StairsType), Z_Construct_UEnum_MeshModelingTools_EProceduralStairsType, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_StairsType_MetaData), NewProp_StairsType_MetaData) }; // 135375770
...
const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_UAddPrimitiveTool_Statics::InterfaceParams[] = {
	{ Z_Construct_UClass_UInteractiveToolCameraFocusAPI_NoRegister, (int32)VTABLE_OFFSET(UAddPrimitiveTool, IInteractiveToolCameraFocusAPI), false },  // 2792920601
};
...
struct Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MeshModelingToolset_Source_MeshModelingTools_Public_AddPrimitiveTool_h_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		{ EMakeMeshPlacementType_StaticEnum, TEXT("EMakeMeshPlacementType"), &Z_Registration_Info_UEnum_EMakeMeshPlacementType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2339221858U) },
		{ EMakeMeshPivotLocation_StaticEnum, TEXT("EMakeMeshPivotLocation"), &Z_Registration_Info_UEnum_EMakeMeshPivotLocation, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2071376036U) },
		{ EMakeMeshPolygroupMode_StaticEnum, TEXT("EMakeMeshPolygroupMode"), &Z_Registration_Info_UEnum_EMakeMeshPolygroupMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3681459679U) },
		{ EProceduralRectType_StaticEnum, TEXT("EProceduralRectType"), &Z_Registration_Info_UEnum_EProceduralRectType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3920753911U) },
		{ EProceduralDiscType_StaticEnum, TEXT("EProceduralDiscType"), &Z_Registration_Info_UEnum_EProceduralDiscType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2075665327U) },
		{ EProceduralSphereType_StaticEnum, TEXT("EProceduralSphereType"), &Z_Registration_Info_UEnum_EProceduralSphereType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2853022235U) },
		{ EProceduralStairsType_StaticEnum, TEXT("EProceduralStairsType"), &Z_Registration_Info_UEnum_EProceduralStairsType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 135375770U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UAddPrimitiveToolBuilder, UAddPrimitiveToolBuilder::StaticClass, TEXT("UAddPrimitiveToolBuilder"), &Z_Registration_Info_UClass_UAddPrimitiveToolBuilder, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAddPrimitiveToolBuilder), 3523752834U) },
		{ Z_Construct_UClass_UProceduralShapeToolProperties, UProceduralShapeToolProperties::StaticClass, TEXT("UProceduralShapeToolProperties"), &Z_Registration_Info_UClass_UProceduralShapeToolProperties, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UProceduralShapeToolProperties), 2370472400U) },
		{ Z_Construct_UClass_UProceduralBoxToolProperties, UProceduralBoxToolProperties::StaticClass, TEXT("UProceduralBoxToolProperties"), &Z_Registration_Info_UClass_UProceduralBoxToolProperties, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UProceduralBoxToolProperties), 2417998873U) },
		{ Z_Construct_UClass_UProceduralRectangleToolProperties, UProceduralRectangleToolProperties::StaticClass, TEXT("UProceduralRectangleToolProperties"), &Z_Registration_Info_UClass_UProceduralRectangleToolProperties, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UProceduralRectangleToolProperties), 1970160698U) },
		{ Z_Construct_UClass_UProceduralDiscToolProperties, UProceduralDiscToolProperties::StaticClass, TEXT("UProceduralDiscToolProperties"), &Z_Registration_Info_UClass_UProceduralDiscToolProperties, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UProceduralDiscToolProperties), 539196324U) },
		{ Z_Construct_UClass_UProceduralTorusToolProperties, UProceduralTorusToolProperties::StaticClass, TEXT("UProceduralTorusToolProperties"), &Z_Registration_Info_UClass_UProceduralTorusToolProperties, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UProceduralTorusToolProperties), 2385894748U) },
		{ Z_Construct_UClass_UProceduralCylinderToolProperties, UProceduralCylinderToolProperties::StaticClass, TEXT("UProceduralCylinderToolProperties"), &Z_Registration_Info_UClass_UProceduralCylinderToolProperties, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UProceduralCylinderToolProperties), 3910032040U) },
		{ Z_Construct_UClass_UProceduralConeToolProperties, UProceduralConeToolProperties::StaticClass, TEXT("UProceduralConeToolProperties"), &Z_Registration_Info_UClass_UProceduralConeToolProperties, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UProceduralConeToolProperties), 4011771937U) },
		{ Z_Construct_UClass_UProceduralArrowToolProperties, UProceduralArrowToolProperties::StaticClass, TEXT("UProceduralArrowToolProperties"), &Z_Registration_Info_UClass_UProceduralArrowToolProperties, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UProceduralArrowToolProperties), 1726390116U) },
		{ Z_Construct_UClass_UProceduralSphereToolProperties, UProceduralSphereToolProperties::StaticClass, TEXT("UProceduralSphereToolProperties"), &Z_Registration_Info_UClass_UProceduralSphereToolProperties, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UProceduralSphereToolProperties), 2783027162U) },
		{ Z_Construct_UClass_UProceduralStairsToolProperties, UProceduralStairsToolProperties::StaticClass, TEXT("UProceduralStairsToolProperties"), &Z_Registration_Info_UClass_UProceduralStairsToolProperties, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UProceduralStairsToolProperties), 1157093418U) },
		{ Z_Construct_UClass_UAddPrimitiveTool, UAddPrimitiveTool::StaticClass, TEXT("UAddPrimitiveTool"), &Z_Registration_Info_UClass_UAddPrimitiveTool, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAddPrimitiveTool), 1474350566U) },
		{ Z_Construct_UClass_UAddBoxPrimitiveTool, UAddBoxPrimitiveTool::StaticClass, TEXT("UAddBoxPrimitiveTool"), &Z_Registration_Info_UClass_UAddBoxPrimitiveTool, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAddBoxPrimitiveTool), 3266765808U) },
		{ Z_Construct_UClass_UAddCylinderPrimitiveTool, UAddCylinderPrimitiveTool::StaticClass, TEXT("UAddCylinderPrimitiveTool"), &Z_Registration_Info_UClass_UAddCylinderPrimitiveTool, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAddCylinderPrimitiveTool), 3733367739U) },
		{ Z_Construct_UClass_UAddConePrimitiveTool, UAddConePrimitiveTool::StaticClass, TEXT("UAddConePrimitiveTool"), &Z_Registration_Info_UClass_UAddConePrimitiveTool, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAddConePrimitiveTool), 3203943137U) },
		{ Z_Construct_UClass_UAddRectanglePrimitiveTool, UAddRectanglePrimitiveTool::StaticClass, TEXT("UAddRectanglePrimitiveTool"), &Z_Registration_Info_UClass_UAddRectanglePrimitiveTool, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAddRectanglePrimitiveTool), 2159457684U) },
		{ Z_Construct_UClass_UAddDiscPrimitiveTool, UAddDiscPrimitiveTool::StaticClass, TEXT("UAddDiscPrimitiveTool"), &Z_Registration_Info_UClass_UAddDiscPrimitiveTool, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAddDiscPrimitiveTool), 562588954U) },
		{ Z_Construct_UClass_UAddTorusPrimitiveTool, UAddTorusPrimitiveTool::StaticClass, TEXT("UAddTorusPrimitiveTool"), &Z_Registration_Info_UClass_UAddTorusPrimitiveTool, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAddTorusPrimitiveTool), 2121545265U) },
		{ Z_Construct_UClass_UAddArrowPrimitiveTool, UAddArrowPrimitiveTool::StaticClass, TEXT("UAddArrowPrimitiveTool"), &Z_Registration_Info_UClass_UAddArrowPrimitiveTool, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAddArrowPrimitiveTool), 3826349509U) },
		{ Z_Construct_UClass_UAddSpherePrimitiveTool, UAddSpherePrimitiveTool::StaticClass, TEXT("UAddSpherePrimitiveTool"), &Z_Registration_Info_UClass_UAddSpherePrimitiveTool, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAddSpherePrimitiveTool), 842593947U) },
		{ Z_Construct_UClass_UAddStairsPrimitiveTool, UAddStairsPrimitiveTool::StaticClass, TEXT("UAddStairsPrimitiveTool"), &Z_Registration_Info_UClass_UAddStairsPrimitiveTool, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAddStairsPrimitiveTool), 3424378172U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MeshModelingToolset_Source_MeshModelingTools_Public_AddPrimitiveTool_h_352360811(TEXT("/Script/MeshModelingTools"),
