...
struct Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Tracks_MovieSceneCameraCutTrack_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneCameraCutTrack, UMovieSceneCameraCutTrack::StaticClass, TEXT("UMovieSceneCameraCutTrack"), &Z_Registration_Info_UClass_UMovieSceneCameraCutTrack, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneCameraCutTrack), 4080546140U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Tracks_MovieSceneCameraCutTrack_h_1560638852(TEXT("/Script/MovieSceneTracks"),
