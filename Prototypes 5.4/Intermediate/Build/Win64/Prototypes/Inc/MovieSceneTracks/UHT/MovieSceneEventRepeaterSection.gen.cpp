...
struct Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Sections_MovieSceneEventRepeaterSection_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneEventRepeaterSection, UMovieSceneEventRepeaterSection::StaticClass, TEXT("UMovieSceneEventRepeaterSection"), &Z_Registration_Info_UClass_UMovieSceneEventRepeaterSection, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneEventRepeaterSection), 3652216317U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Sections_MovieSceneEventRepeaterSection_h_2751577208(TEXT("/Script/MovieSceneTracks"),
