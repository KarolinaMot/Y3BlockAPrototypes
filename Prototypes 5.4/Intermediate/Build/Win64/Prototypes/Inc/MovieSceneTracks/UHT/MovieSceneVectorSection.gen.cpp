...
struct Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Sections_MovieSceneVectorSection_h_Statics
{
	...
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneFloatVectorSection, UMovieSceneFloatVectorSection::StaticClass, TEXT("UMovieSceneFloatVectorSection"), &Z_Registration_Info_UClass_UMovieSceneFloatVectorSection, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneFloatVectorSection), 3453568934U) },
		{ Z_Construct_UClass_UMovieSceneDoubleVectorSection, UMovieSceneDoubleVectorSection::StaticClass, TEXT("UMovieSceneDoubleVectorSection"), &Z_Registration_Info_UClass_UMovieSceneDoubleVectorSection, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneDoubleVectorSection), 347984141U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Sections_MovieSceneVectorSection_h_3443224952(TEXT("/Script/MovieSceneTracks"),
