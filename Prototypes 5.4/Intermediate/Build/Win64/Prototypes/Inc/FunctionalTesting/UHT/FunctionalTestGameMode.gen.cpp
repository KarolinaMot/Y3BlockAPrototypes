...
struct Z_CompiledInDeferFile_FID_Engine_Source_Developer_FunctionalTesting_Classes_FunctionalTestGameMode_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AFunctionalTestGameMode, AFunctionalTestGameMode::StaticClass, TEXT("AFunctionalTestGameMode"), &Z_Registration_Info_UClass_AFunctionalTestGameMode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AFunctionalTestGameMode), 2962726713U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Developer_FunctionalTesting_Classes_FunctionalTestGameMode_h_2182788829(TEXT("/Script/FunctionalTesting"),
