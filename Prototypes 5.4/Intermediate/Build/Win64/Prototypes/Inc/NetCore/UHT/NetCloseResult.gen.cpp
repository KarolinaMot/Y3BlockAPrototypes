...
#include "Runtime/Net/Core/Public/Net/Core/Connection/NetCloseResult.h"
...
struct Z_Construct_UEnum_NetCore_ENetCloseResult_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		...
		{ "IrisNetRefHandleError.Comment", "/** When a specific handle caused a reading error */" },
		{ "IrisNetRefHandleError.Name", "ENetCloseResult::IrisNetRefHandleError" },
		{ "IrisNetRefHandleError.ToolTip", "When a specific handle caused a reading error" },
		{ "IrisProtocolMismatch.Comment", "/** Protocol mismatch in Iris preventing a critical object instantiation */" },
		{ "IrisProtocolMismatch.Name", "ENetCloseResult::IrisProtocolMismatch" },
		{ "IrisProtocolMismatch.ToolTip", "Protocol mismatch in Iris preventing a critical object instantiation" },
		...
		{ "ReplicationChannelCountMaxedOut.Comment", "/** Replication Channel Count was exceeded and channel creation failed */" },
		{ "ReplicationChannelCountMaxedOut.Name", "ENetCloseResult::ReplicationChannelCountMaxedOut" },
		{ "ReplicationChannelCountMaxedOut.ToolTip", "Replication Channel Count was exceeded and channel creation failed" },
	...
	static constexpr UECodeGen_Private::FEnumeratorParam Enumerators[] = {
		...
		{ "ENetCloseResult::ReplicationChannelCountMaxedOut", (int64)ENetCloseResult::ReplicationChannelCountMaxedOut },
		...
		{ "ENetCloseResult::IrisProtocolMismatch", (int64)ENetCloseResult::IrisProtocolMismatch },
		{ "ENetCloseResult::IrisNetRefHandleError", (int64)ENetCloseResult::IrisNetRefHandleError },
...
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_NetCore_ENetCloseResult_Statics::EnumParams = {
	...
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_NetCore_ENetCloseResult_Statics::Enum_MetaDataParams), Z_Construct_UEnum_NetCore_ENetCloseResult_Statics::Enum_MetaDataParams)
};
...
struct Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Net_Core_Public_Net_Core_Connection_NetCloseResult_h_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		{ ENetCloseResult_StaticEnum, TEXT("ENetCloseResult"), &Z_Registration_Info_UEnum_ENetCloseResult, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2974826673U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Net_Core_Public_Net_Core_Connection_NetCloseResult_h_180206617(TEXT("/Script/NetCore"),
	nullptr, 0,
	nullptr, 0,
