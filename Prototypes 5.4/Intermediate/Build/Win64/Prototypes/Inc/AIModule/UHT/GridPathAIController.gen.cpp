...
struct Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AIModule_Classes_GridPathAIController_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AGridPathAIController, AGridPathAIController::StaticClass, TEXT("AGridPathAIController"), &Z_Registration_Info_UClass_AGridPathAIController, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AGridPathAIController), 2455430547U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AIModule_Classes_GridPathAIController_h_1632795122(TEXT("/Script/AIModule"),
