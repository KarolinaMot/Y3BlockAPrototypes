...
const UECodeGen_Private::FClassPropertyParams Z_Construct_UClass_UBTDecorator_IsBBEntryOfClass_Statics::NewProp_TestClass = { "TestClass", nullptr, (EPropertyFlags)0x0024080000000001, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UBTDecorator_IsBBEntryOfClass, TestClass), Z_Construct_UClass_UClass, Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_TestClass_MetaData), NewProp_TestClass_MetaData) };
...
struct Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AIModule_Classes_BehaviorTree_Decorators_BTDecorator_IsBBEntryOfClass_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UBTDecorator_IsBBEntryOfClass, UBTDecorator_IsBBEntryOfClass::StaticClass, TEXT("UBTDecorator_IsBBEntryOfClass"), &Z_Registration_Info_UClass_UBTDecorator_IsBBEntryOfClass, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UBTDecorator_IsBBEntryOfClass), 3116922589U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AIModule_Classes_BehaviorTree_Decorators_BTDecorator_IsBBEntryOfClass_h_3980848175(TEXT("/Script/AIModule"),
