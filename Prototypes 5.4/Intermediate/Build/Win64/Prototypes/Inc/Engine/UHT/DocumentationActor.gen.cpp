...
struct Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_DocumentationActor_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ADocumentationActor, ADocumentationActor::StaticClass, TEXT("ADocumentationActor"), &Z_Registration_Info_UClass_ADocumentationActor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ADocumentationActor), 1805417669U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_DocumentationActor_h_201331040(TEXT("/Script/Engine"),
