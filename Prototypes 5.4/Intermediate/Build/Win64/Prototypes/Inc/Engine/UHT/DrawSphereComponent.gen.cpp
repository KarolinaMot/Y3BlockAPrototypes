...
struct Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Components_DrawSphereComponent_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UDrawSphereComponent, UDrawSphereComponent::StaticClass, TEXT("UDrawSphereComponent"), &Z_Registration_Info_UClass_UDrawSphereComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDrawSphereComponent), 1538599485U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Components_DrawSphereComponent_h_3643612239(TEXT("/Script/Engine"),
