...
#include "Runtime/Engine/Classes/Materials/MaterialExpressionViewSize.h"
...
struct Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Materials_MaterialExpressionViewSize_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UMaterialExpressionViewSize, UMaterialExpressionViewSize::StaticClass, TEXT("UMaterialExpressionViewSize"), &Z_Registration_Info_UClass_UMaterialExpressionViewSize, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMaterialExpressionViewSize), 2424608951U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Materials_MaterialExpressionViewSize_h_1743398607(TEXT("/Script/Engine"),
