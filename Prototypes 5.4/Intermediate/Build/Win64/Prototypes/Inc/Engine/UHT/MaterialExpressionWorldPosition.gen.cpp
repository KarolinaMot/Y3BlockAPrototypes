...
#include "Runtime/Engine/Classes/Materials/MaterialExpressionWorldPosition.h"
...
struct Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Materials_MaterialExpressionWorldPosition_h_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		{ EWorldPositionIncludedOffsets_StaticEnum, TEXT("EWorldPositionIncludedOffsets"), &Z_Registration_Info_UEnum_EWorldPositionIncludedOffsets, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 4222971832U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UMaterialExpressionWorldPosition, UMaterialExpressionWorldPosition::StaticClass, TEXT("UMaterialExpressionWorldPosition"), &Z_Registration_Info_UClass_UMaterialExpressionWorldPosition, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMaterialExpressionWorldPosition), 3116599470U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Materials_MaterialExpressionWorldPosition_h_2247351453(TEXT("/Script/Engine"),
