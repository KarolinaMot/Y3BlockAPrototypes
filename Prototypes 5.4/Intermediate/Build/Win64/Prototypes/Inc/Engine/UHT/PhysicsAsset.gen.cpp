...
struct Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_PhysicsEngine_PhysicsAsset_h_Statics
{
	...
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		...
		{ FSolverIterations::StaticStruct, Z_Construct_UScriptStruct_FSolverIterations_Statics::NewStructOps, TEXT("SolverIterations"), &Z_Registration_Info_UScriptStruct_SolverIterations, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSolverIterations), 1387669731U) },
		{ FPhysicalAnimationProfile::StaticStruct, Z_Construct_UScriptStruct_FPhysicalAnimationProfile_Statics::NewStructOps, TEXT("PhysicalAnimationProfile"), &Z_Registration_Info_UScriptStruct_PhysicalAnimationProfile, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPhysicalAnimationProfile), 1893212146U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UPhysicsAsset, UPhysicsAsset::StaticClass, TEXT("UPhysicsAsset"), &Z_Registration_Info_UClass_UPhysicsAsset, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPhysicsAsset), 1678865647U) },
		{ Z_Construct_UClass_USkeletalBodySetup, USkeletalBodySetup::StaticClass, TEXT("USkeletalBodySetup"), &Z_Registration_Info_UClass_USkeletalBodySetup, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USkeletalBodySetup), 4113366162U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_PhysicsEngine_PhysicsAsset_h_2073183951(TEXT("/Script/Engine"),
