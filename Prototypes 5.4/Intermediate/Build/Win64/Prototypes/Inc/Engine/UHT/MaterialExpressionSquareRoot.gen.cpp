...
#include "Runtime/Engine/Classes/Materials/MaterialExpressionSquareRoot.h"
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMaterialExpressionSquareRoot_Statics::NewProp_Input = { "Input", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMaterialExpressionSquareRoot, Input), Z_Construct_UScriptStruct_FExpressionInput, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Input_MetaData), NewProp_Input_MetaData) };
...
static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionSquareRoot_Statics::PropPointers) < 2048);
UObject* (*const Z_Construct_UClass_UMaterialExpressionSquareRoot_Statics::DependentSingletons[])() = {
	(UObject* (*)())Z_Construct_UClass_UMaterialExpression,
	(UObject* (*)())Z_Construct_UPackage__Script_Engine,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionSquareRoot_Statics::DependentSingletons) < 16);
const UECodeGen_Private::FClassParams Z_Construct_UClass_UMaterialExpressionSquareRoot_Statics::ClassParams = {
	...
	0,
	0x000820B0u,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionSquareRoot_Statics::Class_MetaDataParams), Z_Construct_UClass_UMaterialExpressionSquareRoot_Statics::Class_MetaDataParams)
};
...
struct Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Materials_MaterialExpressionSquareRoot_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UMaterialExpressionSquareRoot, UMaterialExpressionSquareRoot::StaticClass, TEXT("UMaterialExpressionSquareRoot"), &Z_Registration_Info_UClass_UMaterialExpressionSquareRoot, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMaterialExpressionSquareRoot), 3726538541U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Materials_MaterialExpressionSquareRoot_h_633269044(TEXT("/Script/Engine"),
