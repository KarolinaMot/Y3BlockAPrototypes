...
#include "Runtime/Engine/Public/WorldPartition/WorldPartitionMiniMapVolume.h"
...
static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_AWorldPartitionMiniMapVolume_Statics::DependentSingletons) < 16);
const UECodeGen_Private::FClassParams Z_Construct_UClass_AWorldPartitionMiniMapVolume_Statics::ClassParams = {
	...
	0,
	0x008800A4u,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AWorldPartitionMiniMapVolume_Statics::Class_MetaDataParams), Z_Construct_UClass_AWorldPartitionMiniMapVolume_Statics::Class_MetaDataParams)
};
...
struct Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_WorldPartition_WorldPartitionMiniMapVolume_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AWorldPartitionMiniMapVolume, AWorldPartitionMiniMapVolume::StaticClass, TEXT("AWorldPartitionMiniMapVolume"), &Z_Registration_Info_UClass_AWorldPartitionMiniMapVolume, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AWorldPartitionMiniMapVolume), 2021970660U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_WorldPartition_WorldPartitionMiniMapVolume_h_1640332958(TEXT("/Script/Engine"),
