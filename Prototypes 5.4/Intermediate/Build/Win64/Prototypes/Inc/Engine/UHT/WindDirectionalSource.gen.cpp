...
struct Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_WindDirectionalSource_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AWindDirectionalSource, AWindDirectionalSource::StaticClass, TEXT("AWindDirectionalSource"), &Z_Registration_Info_UClass_AWindDirectionalSource, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AWindDirectionalSource), 1289813170U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_WindDirectionalSource_h_2202800378(TEXT("/Script/Engine"),
