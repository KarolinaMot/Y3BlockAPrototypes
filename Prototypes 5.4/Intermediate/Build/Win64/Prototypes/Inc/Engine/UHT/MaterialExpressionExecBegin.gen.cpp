...
#include "Runtime/Engine/Classes/Materials/MaterialExpressionExecBegin.h"
...
struct Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Materials_MaterialExpressionExecBegin_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UMaterialExpressionExecBegin, UMaterialExpressionExecBegin::StaticClass, TEXT("UMaterialExpressionExecBegin"), &Z_Registration_Info_UClass_UMaterialExpressionExecBegin, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMaterialExpressionExecBegin), 101721982U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Materials_MaterialExpressionExecBegin_h_1728464696(TEXT("/Script/Engine"),
