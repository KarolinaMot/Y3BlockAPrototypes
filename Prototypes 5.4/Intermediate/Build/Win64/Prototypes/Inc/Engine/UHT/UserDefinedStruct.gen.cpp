...
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_Engine_EUserDefinedStructureStatus_Statics::EnumParams = {
	...
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_Engine_EUserDefinedStructureStatus_Statics::Enum_MetaDataParams), Z_Construct_UEnum_Engine_EUserDefinedStructureStatus_Statics::Enum_MetaDataParams)
};
...
#endif // WITH_EDITORONLY_DATA
const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UUserDefinedStruct_Statics::NewProp_Status = { "Status", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UUserDefinedStruct, Status), Z_Construct_UEnum_Engine_EUserDefinedStructureStatus, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Status_MetaData), NewProp_Status_MetaData) }; // 1605295490
...
struct Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_UserDefinedStruct_h_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		{ EUserDefinedStructureStatus_StaticEnum, TEXT("EUserDefinedStructureStatus"), &Z_Registration_Info_UEnum_EUserDefinedStructureStatus, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1605295490U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UUserDefinedStruct, UUserDefinedStruct::StaticClass, TEXT("UUserDefinedStruct"), &Z_Registration_Info_UClass_UUserDefinedStruct, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UUserDefinedStruct), 548165363U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_UserDefinedStruct_h_2709918578(TEXT("/Script/Engine"),
