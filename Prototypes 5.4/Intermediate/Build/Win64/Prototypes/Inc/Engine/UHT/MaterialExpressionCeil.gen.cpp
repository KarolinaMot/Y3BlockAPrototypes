...
#include "Runtime/Engine/Classes/Materials/MaterialExpressionCeil.h"
...
struct Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Materials_MaterialExpressionCeil_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UMaterialExpressionCeil, UMaterialExpressionCeil::StaticClass, TEXT("UMaterialExpressionCeil"), &Z_Registration_Info_UClass_UMaterialExpressionCeil, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMaterialExpressionCeil), 3063336015U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Materials_MaterialExpressionCeil_h_470310756(TEXT("/Script/Engine"),
