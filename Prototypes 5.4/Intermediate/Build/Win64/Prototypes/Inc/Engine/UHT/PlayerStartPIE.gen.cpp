...
struct Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_PlayerStartPIE_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_APlayerStartPIE, APlayerStartPIE::StaticClass, TEXT("APlayerStartPIE"), &Z_Registration_Info_UClass_APlayerStartPIE, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(APlayerStartPIE), 702645438U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_PlayerStartPIE_h_885087644(TEXT("/Script/Engine"),
