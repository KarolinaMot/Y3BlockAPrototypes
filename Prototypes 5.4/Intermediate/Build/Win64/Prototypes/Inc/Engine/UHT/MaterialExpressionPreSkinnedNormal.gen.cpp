...
#include "Runtime/Engine/Classes/Materials/MaterialExpressionPreSkinnedNormal.h"
...
static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionPreSkinnedNormal_Statics::DependentSingletons) < 16);
const UECodeGen_Private::FClassParams Z_Construct_UClass_UMaterialExpressionPreSkinnedNormal_Statics::ClassParams = {
	...
	0,
	0x000820B0u,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionPreSkinnedNormal_Statics::Class_MetaDataParams), Z_Construct_UClass_UMaterialExpressionPreSkinnedNormal_Statics::Class_MetaDataParams)
};
...
struct Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Materials_MaterialExpressionPreSkinnedNormal_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UMaterialExpressionPreSkinnedNormal, UMaterialExpressionPreSkinnedNormal::StaticClass, TEXT("UMaterialExpressionPreSkinnedNormal"), &Z_Registration_Info_UClass_UMaterialExpressionPreSkinnedNormal, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMaterialExpressionPreSkinnedNormal), 2675212811U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Materials_MaterialExpressionPreSkinnedNormal_h_3513750378(TEXT("/Script/Engine"),
