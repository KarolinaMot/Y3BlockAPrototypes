...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRuntimeCurveLinearColor_Statics::NewProp_ColorCurves = { "ColorCurves", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, CPP_ARRAY_DIM(ColorCurves, FRuntimeCurveLinearColor), STRUCT_OFFSET(FRuntimeCurveLinearColor, ColorCurves), Z_Construct_UScriptStruct_FRichCurve, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_ColorCurves_MetaData), NewProp_ColorCurves_MetaData) }; // 1340883375
...
struct Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Curves_CurveLinearColor_h_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FRuntimeCurveLinearColor::StaticStruct, Z_Construct_UScriptStruct_FRuntimeCurveLinearColor_Statics::NewStructOps, TEXT("RuntimeCurveLinearColor"), &Z_Registration_Info_UScriptStruct_RuntimeCurveLinearColor, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRuntimeCurveLinearColor), 2743372398U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UCurveLinearColor, UCurveLinearColor::StaticClass, TEXT("UCurveLinearColor"), &Z_Registration_Info_UClass_UCurveLinearColor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCurveLinearColor), 3453313843U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Curves_CurveLinearColor_h_4023829704(TEXT("/Script/Engine"),
