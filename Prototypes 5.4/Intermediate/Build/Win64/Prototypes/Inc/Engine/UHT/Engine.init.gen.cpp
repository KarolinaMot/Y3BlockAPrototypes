...
void EmptyLinkFunctionForGeneratedCodeEngine_init() {}
	...
	FORCENOINLINE UPackage* Z_Construct_UPackage__Script_Engine()
	{
		if (!Z_Registration_Info_UPackage__Script_Engine.OuterSingleton)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				...
				(UObject* (*)())Z_Construct_UScriptStruct_FSubstrateMaterialInput,
				...
				(UObject* (*)())Z_Construct_UDelegateFunction_Engine_BreakEventSignature__DelegateSignature,
				...
				(UObject* (*)())Z_Construct_UDelegateFunction_Engine_CollisionEventSignature__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_Engine_ConstraintBrokenSignature__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_Engine_CrumblingEventSignature__DelegateSignature,
				...
				(UObject* (*)())Z_Construct_UDelegateFunction_Engine_OnClusterUnionAddedComponent__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_Engine_OnClusterUnionBoundsChanged__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_Engine_OnClusterUnionRemovedComponent__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_Engine_OnDataLayerInstanceRuntimeStateChanged__DelegateSignature,
				...
				(UObject* (*)())Z_Construct_UDelegateFunction_Engine_OnLocalPlayerSaveGameLoaded__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_Engine_OnMontageBlendedInEndedMCDelegate__DelegateSignature,
				...
				(UObject* (*)())Z_Construct_UDelegateFunction_Engine_RemovalEventSignature__DelegateSignature,
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferPackage_UPackage__Script_Engine(Z_Construct_UPackage__Script_Engine, TEXT("/Script/Engine"), Z_Registration_Info_UPackage__Script_Engine, CONSTRUCT_RELOAD_VERSION_INFO(FPackageReloadVersionInfo, 0x6FDA2A3A, 0x4726BAB9));
