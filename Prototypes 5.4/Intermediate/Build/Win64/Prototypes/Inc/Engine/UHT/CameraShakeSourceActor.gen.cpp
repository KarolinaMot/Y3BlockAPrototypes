...
struct Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Camera_CameraShakeSourceActor_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ACameraShakeSourceActor, ACameraShakeSourceActor::StaticClass, TEXT("ACameraShakeSourceActor"), &Z_Registration_Info_UClass_ACameraShakeSourceActor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ACameraShakeSourceActor), 3699065904U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Camera_CameraShakeSourceActor_h_3928193640(TEXT("/Script/Engine"),
