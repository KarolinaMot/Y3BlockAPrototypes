...
struct Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_GeneratedMeshAreaLight_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AGeneratedMeshAreaLight, AGeneratedMeshAreaLight::StaticClass, TEXT("AGeneratedMeshAreaLight"), &Z_Registration_Info_UClass_AGeneratedMeshAreaLight, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AGeneratedMeshAreaLight), 1078649189U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_GeneratedMeshAreaLight_h_3415374125(TEXT("/Script/Engine"),
