...
static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_AKillZVolume_Statics::DependentSingletons) < 16);
const UECodeGen_Private::FClassParams Z_Construct_UClass_AKillZVolume_Statics::ClassParams = {
	...
	0,
	0x008800A4u,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AKillZVolume_Statics::Class_MetaDataParams), Z_Construct_UClass_AKillZVolume_Statics::Class_MetaDataParams)
};
...
struct Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_GameFramework_KillZVolume_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AKillZVolume, AKillZVolume::StaticClass, TEXT("AKillZVolume"), &Z_Registration_Info_UClass_AKillZVolume, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AKillZVolume), 1766499391U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_GameFramework_KillZVolume_h_3924067203(TEXT("/Script/Engine"),
