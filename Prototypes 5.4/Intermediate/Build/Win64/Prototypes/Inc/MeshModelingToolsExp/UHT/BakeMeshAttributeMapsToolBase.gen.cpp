...
const UECodeGen_Private::FMapPropertyParams Z_Construct_UClass_UBakeMeshAttributeMapsToolBase_Statics::NewProp_CachedMaps = { "CachedMaps", nullptr, (EPropertyFlags)0x0124080000000000, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UBakeMeshAttributeMapsToolBase, CachedMaps), EMapPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_CachedMaps_MetaData), NewProp_CachedMaps_MetaData) }; // 1895485023
...
struct Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_MeshModelingToolsetExp_Source_MeshModelingToolsExp_Public_BakeMeshAttributeMapsToolBase_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UBakeMeshAttributeMapsResultToolProperties, UBakeMeshAttributeMapsResultToolProperties::StaticClass, TEXT("UBakeMeshAttributeMapsResultToolProperties"), &Z_Registration_Info_UClass_UBakeMeshAttributeMapsResultToolProperties, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UBakeMeshAttributeMapsResultToolProperties), 2055904481U) },
		{ Z_Construct_UClass_UBakeMeshAttributeMapsToolBase, UBakeMeshAttributeMapsToolBase::StaticClass, TEXT("UBakeMeshAttributeMapsToolBase"), &Z_Registration_Info_UClass_UBakeMeshAttributeMapsToolBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UBakeMeshAttributeMapsToolBase), 172258768U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_MeshModelingToolsetExp_Source_MeshModelingToolsExp_Public_BakeMeshAttributeMapsToolBase_h_3535853495(TEXT("/Script/MeshModelingToolsExp"),
