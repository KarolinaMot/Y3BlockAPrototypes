...
struct Z_Construct_UClass_UBlendStackRootCameraNode_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam Class_MetaDataParams[] = {
		...
		{ "ToolTip", "Root camera node for running a camera mode in a blend stack.\nThis camera node wraps both the camera mode's root node, and the\nblend node used to blend it." },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_Blend_MetaData[] = {
		{ "Comment", "/** The blend to use on the camera mode. */" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Private/Core/BlendStackRootCameraNode.h" },
		{ "ToolTip", "The blend to use on the camera mode." },
	};
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UBlendStackRootCameraNode_Statics::NewProp_Blend = { "Blend", nullptr, (EPropertyFlags)0x0144000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UBlendStackRootCameraNode, Blend), Z_Construct_UClass_UBlendCameraNode_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Blend_MetaData), NewProp_Blend_MetaData) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UBlendStackRootCameraNode_Statics::NewProp_RootNode = { "RootNode", nullptr, (EPropertyFlags)0x0144000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UBlendStackRootCameraNode, RootNode), Z_Construct_UClass_UCameraNode_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_RootNode_MetaData), NewProp_RootNode_MetaData) };
...
struct Z_CompiledInDeferFile_FID_Engine_Plugins_Cameras_GameplayCameras_Source_GameplayCameras_Private_Core_BlendStackRootCameraNode_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UBlendStackRootCameraNode, UBlendStackRootCameraNode::StaticClass, TEXT("UBlendStackRootCameraNode"), &Z_Registration_Info_UClass_UBlendStackRootCameraNode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UBlendStackRootCameraNode), 2248208616U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Cameras_GameplayCameras_Source_GameplayCameras_Private_Core_BlendStackRootCameraNode_h_18243435(TEXT("/Script/GameplayCameras"),
